...
const doc = {
  ...
  definitions: {
    ...
    DNSMetadata: {
      $name: 'DNS name',
      $description: 'Short DNS name description',
      $attributes: 'Custom traits about DNS',
      $name_length: 'Character length of dns name',
      $url: 'DNS App URL of the name',
      $version: 'DNS NFT version',
      $background_image: 'Origin URL of avatar image',
      $image_url: 'URL of DNS NFT image',
    },
  ...
  components: {
    examples: {
      ...
      DNSMetadata: {
        ...
        version: 0,
        background_image:
          'https://metadata.dns.domains/mainnet/avatar/nick.dao',
        image_url:
          'https://metadata.dns.domains/mainnet/0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85/0x5d5727cb0fb76e4944eafb88ec9a3cf0b3c9025a4b2f947729137c5d7f84f68f/image',
      },
    },
  },
};
